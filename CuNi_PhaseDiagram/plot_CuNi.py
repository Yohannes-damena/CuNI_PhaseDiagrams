...
# Calculate Isobaric Binary Phase Diagram (always regenerate)
fig = plt.figure(figsize=(9,6))
binplot(db_cuni, ['CU', 'NI', 'VA'] , my_phases_cuni, {v.X('NI'):(0,1,0.01),  v.T: (400, 1800, 5), v.P:101325},  ax=fig.gca())
...
# Calculate Energy Surfaces of Binary Systems (always regenerate)
